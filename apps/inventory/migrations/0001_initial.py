    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movement_type', models.CharField(choices=[('DISPATCH_OUT', 'Dispatched to Salesperson'), ('RETURN_IN', 'Returned from Salesperson'), ('PURCHASE', 'New Crates Purchased'), ('DAMAGE', 'Crates Damaged'), ('REPAIR', 'Crates Repaired'), ('COUNT', 'Physical Count Adjustment')], help_text='Type of crate movement', max_length=20)),
